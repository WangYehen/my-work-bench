...
export function MeetingsPage() {
  ...
  const selectedEvents = useMemo(() => mergeDuplicateMeetings(events.filter((event) => event.startAt?.slice(0, 10) === selectedDate)).sort((a, b) => String(a.startAt).localeCompare(String(b.startAt))), [events, selectedDate]);
